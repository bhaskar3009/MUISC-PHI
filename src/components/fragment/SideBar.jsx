    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            ...
            <div className="aside-bar-container playlist">
                ...
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/instrumental"}  title={"happy"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/electronic"}  title={"sad"}/>
            </div>
        </aside>
    );
}
